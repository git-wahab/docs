...
| `fulfillment_status` | string | — | Filter by fulfillment status: `pending`, `processing`, `partially_fulfilled`, `completed`, `refunded`, `cancelled` |
| `payment_status` | string | — | Filter by payment status: `pending`, `completed`, `cancelled` |
  ...
  "data": [
    {
      ...
      "currency": "EUR",
      "client_reference": "order-2024-000123",
      "items": [],
